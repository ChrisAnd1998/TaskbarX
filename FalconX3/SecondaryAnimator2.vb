...
Public Class SecondaryAnimator2
    ...
    Private Sub Panel1_Move(sender As Object, e As EventArgs) Handles Panel1.Move
        ...
        If FalconX.Horizontal = False Then
            SetWindowPos(FalconX.SecondTaskbarPtr, IntPtr.Zero, 0, position, 0, 0, FalconX.SWP_NOZORDER Or FalconX.SWP_NOSIZE Or FalconX.SWP_ASYNCWINDOWPOS Or FalconX.SWP_NOSENDCHANGING Or FalconX.SWP_NOACTIVATE)
        Else
            SetWindowPos(FalconX.SecondTaskbarPtr, IntPtr.Zero, position, 0, 0, 0, FalconX.SWP_NOSIZE Or FalconX.SWP_ASYNCWINDOWPOS Or FalconX.SWP_NOACTIVATE)
        End If
